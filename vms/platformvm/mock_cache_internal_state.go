...
import (
	...
	verify "github.com/chain4travel/caminogo/vms/components/verify"
...
// AddMultisigOwners mocks base method.
func (m *MockInternalState) AddMultisigOwners(arg0 ids.ShortID, arg1 secp256k1fx.OutputOwners) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "AddMultisigOwners", arg0, arg1)
}

// AddMultisigOwners indicates an expected call of AddMultisigOwners.
func (mr *MockInternalStateMockRecorder) AddMultisigOwners(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "AddMultisigOwners", reflect.TypeOf((*MockInternalState)(nil).AddMultisigOwners), arg0, arg1)
}
...
// GetMultisigOwners mocks base method.
func (m *MockInternalState) GetMultisigOwners(id ids.ShortID) (secp256k1fx.OutputOwners, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetMultisigOwners", id)
	ret0, _ := ret[0].(secp256k1fx.OutputOwners)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetMultisigOwners indicates an expected call of GetMultisigOwners.
func (mr *MockInternalStateMockRecorder) GetMultisigOwners(id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetMultisigOwners", reflect.TypeOf((*MockInternalState)(nil).GetMultisigOwners), id)
}
...
// GetUTXOMultisigOwners mocks base method.
func (m *MockInternalState) GetUTXOMultisigOwners(utxo *avax.UTXO) (verify.Verifiable, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetUTXOMultisigOwners", utxo)
	ret0, _ := ret[0].(verify.Verifiable)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetUTXOMultisigOwners indicates an expected call of GetUTXOMultisigOwners.
func (mr *MockInternalStateMockRecorder) GetUTXOMultisigOwners(utxo interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetUTXOMultisigOwners", reflect.TypeOf((*MockInternalState)(nil).GetUTXOMultisigOwners), utxo)
}
