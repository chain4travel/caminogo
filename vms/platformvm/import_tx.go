...
func (tx *UnsignedImportTx) Execute(
	...
	if vm.bootstrapped.GetValue() {
		...
		if err := vm.semanticVerifySpendUTXOs(tx, utxos, ins, tx.Outs, stx.Creds, vm.TxFee, vm.ctx.AVAXAssetID, spendModeBond); err != nil {
			return nil, err
		}
	}
...
func (vm *VM) newImportTx(
	...
	if importedAmount < vm.TxFee { // imported amount goes toward paying tx fee
		...
		ins, outs, _, _, baseSigners, err = vm.spend(keys, 0, vm.TxFee-importedAmount, changeAddr, spendModeBond)
		if err != nil {
