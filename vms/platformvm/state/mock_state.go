...
func (m *MockState) AddProposal(arg0 *dao.Proposal) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "AddProposal", arg0)
}

// AddProposal indicates an expected call of AddProposal.
func (mr *MockStateMockRecorder) AddProposal(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "AddProposal", reflect.TypeOf((*MockState)(nil).AddProposal), arg0)
}
...
func (m *MockState) AddVote(arg0 ids.ID, arg1 *dao.Vote) error {
	m.ctrl.T.Helper()
...
func (m *MockState) GetAllProposals() ([]*dao.Proposal, error) {
	m.ctrl.T.Helper()
...
func (m *MockState) GetProposal(arg0 ids.ID) (*dao.Proposal, error) {
	m.ctrl.T.Helper()
