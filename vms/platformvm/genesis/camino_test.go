...
func TestSameMSigDefinitionsResultedWithSameAlias(t *testing.T) {
	...
	msig1, err := NewMultisigAlias(txID, []ids.ShortID{ids.ShortEmpty}, 1, nil)
	msig2, _ := NewMultisigAlias(txID, []ids.ShortID{ids.ShortEmpty}, 1, nil)
...
func TestMemoIsPartOfTheAliasComputation(t *testing.T) {
	...
	msig1, err1 := NewMultisigAlias(txID, []ids.ShortID{ids.ShortEmpty}, 1, nil)
	msig2, err2 := NewMultisigAlias(txID, []ids.ShortID{ids.ShortEmpty}, 1, []byte("memo"))
...
func TestTxIDIsPartOfAliasComputation(t *testing.T) {
	...
	msig1, err1 := NewMultisigAlias(txID1, addrs, 1, nil)
	msig2, err2 := NewMultisigAlias(txID2, addrs, 1, nil)
...
func TestMemoSizeShouldBeLowerThanMaxMemoSize(t *testing.T) {
	...
	_, err := NewMultisigAlias(txID, []ids.ShortID{ids.ShortEmpty}, 1, tooLargeMemo)
...
func TestMSigShouldContainAtLeastOneAddress(t *testing.T) {
	...
	_, err := NewMultisigAlias(txID, []ids.ShortID{}, 1, nil)
...
func TestMSigThresholdShouldBeLowerThanAddressesCount(t *testing.T) {
	...
	_, err := NewMultisigAlias(txID, []ids.ShortID{ids.ShortEmpty}, 2, nil)
...
func TestMSigThresholdShouldBePositive(t *testing.T) {
	...
	_, err := NewMultisigAlias(txID, []ids.ShortID{ids.ShortEmpty}, 0, nil)
...
func TestMSigThresholdIsComparedToUniqueAddressesCount(t *testing.T) {
	...
	_, err := NewMultisigAlias(txID, []ids.ShortID{ids.ShortEmpty, ids.ShortEmpty}, 2, nil)
...
func TestKnownValueAliasComputationTests(t *testing.T) {
	knownValueTests := []struct {
		...
		},
		{
			...
			addresses:     []ids.ShortID{ids.ShortEmpty},
			threshold:     1,
			memo:          []byte("Camino FTW!"),
			expectedAlias: "NbNhG6wZFdSyTgBpoSYkbiPJ83P8YwHDa",
		},
		{
			txID:          ids.Empty,
