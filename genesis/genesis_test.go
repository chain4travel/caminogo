...
func TestGenesis(t *testing.T) {
	tests := []struct {
		...
		{
			networkID:  constants.ColumbusID,
			expectedID: "YvF9mEEPgkCvxowA9c3tprs78o8VK7C15W8TudGr8MiaG7jK5",
		},
		{
			networkID:  constants.KopernikusID,
	...
	tests := []struct {
		...
		},
		{
			...
			vmTest: []vmTest{
				{
					vmID:       constants.AVMID,
					expectedID: "2mvrUCxfWijcFkj64Swh3eMdpefqs9MgFBddjBFbQ2Abtfugtn",
				},
				{
					vmID:       constants.EVMID,
...
func TestAVAXAssetID(t *testing.T) {
	tests := []struct {
		...
		{
			networkID:  constants.KopernikusID,
			expectedID: "2Q4U5CR7YVtkm12CrTjg4kcfZvu2ckET34VrxbZeEz7183yXW9",
		},
		{
			networkID:  constants.LocalID,
